...
- TypeScript 5.x (ES2022 target) + Vite 5.1.6 (build), Vitest 1.3.1 (unit tests), Playwright 1.42.1 (acceptance tests), Canvas API (rendering) (003-food-spawning)
- In-memory game state (no persistence) (003-food-spawning)
